    ...
    <div className=''>
        ...
        <div className='max-w-screen-xl mx-auto'>
          <div className='flex flex-col justify-center items-center h-[90vh] w-[100%]'>
            <p className='z-10 text-5xl text-black text-center w-[80vw] font-poppins max-w-screen-2xl'>
              Evolve, pioneer, and deliver solutions in tune with the pace of business.
            </p>
            <div className='z-10 pt-10'>
              <button className='px-10 py-1 border-2 border-black rounded-3xl text-black hover:bg-blue hover:border-blue'>
                Read More
              </button>
            </div>
          </div>
